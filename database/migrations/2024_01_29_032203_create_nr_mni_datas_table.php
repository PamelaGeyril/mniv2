...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('nr_mni_datas', function (Blueprint $table) {
            ...
            $table->enum('status_call', ['free', 'on-call'])->default('free');
            ...
            $table->text('squarefeet_d', 200)->nullable();
            ...
            $table->text('parentname_d', 200)->nullable();
            $table->text('parentcity', 200)->nullable();
            $table->text('parentcity_d', 200)->nullable();
            $table->text('parentstate', 200)->nullable();
            $table->text('parentstate_d', 200)->nullable();
            ...
            $table->string('fdisp'  )->default(0)->nullable();
            ...
            $table->string('filesNamePath');
            $table->string('callPriority')->default(0);
    ...
    {
        Schema::dropIfExists('nr_mni_datas');
    }
};
